...
import { PackageExports } from 'keywork/__internal/package-exports'
import * as ProjectFiles from 'keywork/__internal/project'
import { load as loadMarkdownPlugin, MarkdownTheme, MarkdownThemeOptions } from 'keywork/__internal/typedoc/theme'
...
export class DocusaurusTypeDoc extends TypeDoc.Application {
  ...
  getEntryPoints(): TypeDoc.DocumentationEntryPoint[] | undefined {
    ...
    for (const [namedExport, entry] of Object.entries(this.exports)) {
      ...
      const entryPointPath = path.join(ProjectFiles.ModulesDirectory, entry.import.replaceAll('.js', '.js'))
